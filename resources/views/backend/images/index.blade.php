...
@section("add_new_url",url("/products/$product->product_id/images/create"))
...
<table class="table table-striped table-sm">
    ...
    <tr id="{{$image->image_id}}">
        <td><img src="{{asset("/storage/products/$image->image_url")}}" alt="{{$image->alt}}" width="100"></td>
        <td>{{$image->seq}}</td>
            ...
            <ul class="nav float-start">
                ...
                <li class="nav-item">
                    <a class="nav-link list-item-delete text-black"
                       href="{{url("/products/$product->product_id/images/$image->image_id/delete")}}">
